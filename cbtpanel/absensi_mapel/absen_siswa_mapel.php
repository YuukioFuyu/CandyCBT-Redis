  ...
  <div class='col-md-12'>
    <div class='box box-solid'>
      <div class='box-header with-border '>
        <h3 class='box-title'>Absen Siswa Mapel Manual</h3>
      </div>
      <div class='box-body'>
        <div class="row" >
          <div class="col-md-12">
            <div class="alert alert-info">
              <strong>Info !</strong> Pada Menu ini Guru bisa mengabsen siswa secara Manual
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    location.replace("?pg=absen_siswamapel&mapel="+mapel+"&level="+lv+"&kelas="+kelas+"&kodekelas="+kodekelas);
     });
    ...
    $(document).on('click', '#cari_absen', function() {
      ...
      id_array = new Array();
        ...
        if(id_array.length === 0){
          ...
          //console.log(i);
          $.ajax({
            url: "<?php echo "c_aksi.php?absen_mapel_siswa=insert"; ?>",
            //data: "idsiswa="+id_array+"&idkelas="+idkelas+"&idabsenmapel="+idabsenmapel+"&kodemapel="+idmapel+"&tgl="+tgl,
            data: { 
              idsiswa: id_array,
              idkelas:idkelas,
