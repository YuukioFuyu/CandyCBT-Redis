		...
		<div class='col-md-12'>
			<div class='box box-solid'>
				<div class='box-header with-border'>
					<h3 class='box-title'><i class="fas fa-file-signature fa-fw   "></i> DATA UJIAN AKTIF SEMUA NILAI PER BANK SOAL</h3>
						...
						<table id='example' class='table table-bordered table-striped'>
							<thead>
								<tr>
									...
									<?php
									$mapelQ = mysqli_query($koneksi, "SELECT * FROM mapel a INNER JOIN $tabel b ON a.id_mapel=b.id_mapel GROUP BY b.id_ujian ");
								...
								<tr>
									<?php
									$kode = mysqli_query($koneksi, "SELECT * FROM mapel a INNER JOIN $tabel b ON a.id_mapel=b.id_mapel GROUP BY b.id_ujian");
								...
								<tr>
									<?php $mapelQ = mysqli_query($koneksi, "SELECT * FROM mapel a INNER JOIN $tabel b ON a.id_mapel=b.id_mapel GROUP BY b.id_ujian "); ?>
							...
							<tbody>
								...
								<?php while ($siswa = mysqli_fetch_array($siswaQ)) : ?>
									...
									<tr>
										...
										<?php while ($mapel = mysqli_fetch_array($mapelQ)) : ?>
											<?php
											$nilaiQ = mysqli_query($koneksi, "SELECT * FROM $tabel WHERE id_ujian='$mapel[id_ujian]' AND id_siswa='$siswa[id_siswa]' and kode_ujian='$mapel[kode_ujian]'");
