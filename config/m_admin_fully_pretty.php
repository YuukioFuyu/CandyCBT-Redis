...
//&formnilai.php -------------------------------------
  ...
  function v_pengawas($id){
 //tampilkan pengawas berdasakan id 
...
//&anso ----------analisa soal
  ...
  function v_anso1($id_mapel){
 //looping soal dan jawabanya
  ...
  function v_anso2($id_mapel){
 //menampilkan nama mapel, leve, kelas
...
//&nilai function  Nilai2.php -------------------------------------------------------------------------------------
 ...
 //tampil siswa
    ...
    function Tampil_nilai3($id_siswa){
 //tampil siswa beserta nilai benar salah
      $tabel='nilai_pindah';
...
//mkks sinkron server ---------------------------------------------------------
 ...
 //300 seconds = 5 minutes
  ...
  function CekServerCurlIn($urlApi){
 //digunakan untuk get data json api
    $headers = [
      'Content-Type: application/json',
