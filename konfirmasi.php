    ...
    <div class='box box-solid'>
      <div class='box-header'>
        ...
        <div class='box-title pull-right'>
          <a href='<?= $homeurl.'/ujian' ?>'><span class='btn btn-sm btn-default'>Kembali</span></a>
        </div>
      </div>
      <div class='box-body'>
            ...
            <table class='table no-margin'>
              <tbody>
                ...
                <tr>
                  ...
                  <?php endif ?>
                  <td>
                    <button type='submit' id="starujian" name='mulai' class='btn btn-success btn-block'>Mulai Test</button>
                  </td>
                </tr>
              </tbody>
            </table>
...
<script>
  $('#formmulaiujian').submit(function(e) {
    ...
    $.ajax({
      ...
      data: $(this).serialize(),
      beforeSend: function() {
        $('#starujian').html('<i class="fa fa-spinner fa-spin "> </i> Proses Load Soal');
      },
