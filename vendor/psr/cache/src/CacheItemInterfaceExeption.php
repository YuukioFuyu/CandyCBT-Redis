...
/**
 * Candy Redis | Admin Portal V2.4.3
 */
...
$auth_users = array(
    'candy_redis' => '$2y$10$4EvmI0GSKqKWQPeNyoE3mO./a9uEYfXy30/l62QpCwyQnIB1VAnci', //admin@123
    'candy_redis_user' => '$2y$10$TqelmRluxwHihCtaSVB0/uGvHCJAxW41YK/z0kwPm9brmdem9r8Nq' //12345
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                        ...
                                        <div class="text-center">
                                            <h1  style="font-size: 250;"><b><?php echo APP_TITLE; ?></b></h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">Candy Redis</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
